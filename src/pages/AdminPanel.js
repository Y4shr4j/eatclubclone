        ...
        <aside className='bg-white min-h-full  w-full  max-w-60 customShadow'>
                ...
                <div>   
                    <nav className='grid p-4'>
                        ...
                        <Link to={"all-restaurants"} className='px-2 py-1 hover:bg-slate-100'>RESTAURANTS</Link>
                        <Link to={"all-delivery"} className='px-2 py-1 hover:bg-slate-100'>DELIVERY MAN</Link>
